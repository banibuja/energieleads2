...
<div className="lg:bg-black bg-[#0a0a0a] fixed top-0 w-full z-50">
    ...
    <div className="content relative z-20 bg-black">
      ...
      <button className="mt-[1.5rem] z-[1001] fixed right-0 top-[48rem] lg:top-[48rem] mr-3 px-6 py-2 bg-[#fbcf44] text-white rounded-[12px] hover:ring-4 hover:ring-[rgba(102,72,250,0.5)] transition duration-300 ease-in-out sm:px-4 sm:py-2 flex items-center">
  Jetzt Testen
